...
public class ViolatorContentsActivity extends AdsActivity implements ViolatorContentsPresenter.View {

  @Inject ViolatorContentsPresenter presenter;
  ...
  @Override public void setListener() {
    ...
    swipe.setOnRefreshListener(() -> presenter.onRefresh(
        ViolatorContentsActivity.this.getIntent()));
  }
