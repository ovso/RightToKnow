...
public class VFacilityDetailPresenterImpl implements VFacilityDetailPresenter {
  private static final double LAT_SEOUL = 37.5652894;
  private static final double LNG_SEOUL = 126.8494635;
  ...
  VFacilityDetailPresenterImpl(VFacilityDetailPresenter.View view) {
    ...
    geocodeNetwork =
        new GeocodeNetwork(
            App.getInstance().getApplicationContext(), GeocodeNetwork.GEOCODING_BASE_URL);
  }
  ...
  @Override
  public void onMapClick(Intent intent) {
    view.showLoading();
